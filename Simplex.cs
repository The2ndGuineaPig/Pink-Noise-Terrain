// Simplex noise based on: Simplex noise demystified, Stefan Gustavson, Linköping University, Sweden (stegu@itn.liu.se), 2005-03-22
...
myClass = new SimplexNoise();
GD.Print(myClass.noise(0.5, 0.5));
double value = myClass.noise(0.5, 0.5);
GD.Print(value);
```
